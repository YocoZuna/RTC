...
if(EXISTS "${ST_CLT_PATH}")
    ...
    file(GLOB TOOLCHAIN_DIRECTORIES
        "C:/ST/STM32CubeIDE_1.10.1/STM32CubeIDE/plugins/com.st.stm32cube.ide.mcu.externaltools.gnu-tools-for-stm32.*/tools/bin/"
...
if(TOOLCHAIN_DIRECTORIES_COUNT LESS 1)
    ...
    if (TOOLCHAIN_DIRECTORIES_COUNT GREATER 1)
        message(WARNING "Found multiple STM32CubeIDE installations. Using \"${TOOLCHAIN_DIRECTORY}\".")
    endif()
endif()
